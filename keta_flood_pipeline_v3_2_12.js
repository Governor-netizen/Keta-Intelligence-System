// =====================================================================
// KETA COASTAL FLOOD PREDICTION -- PRODUCTION GEE SCRIPT v3.2.12
...
Export.table.toDrive({
  collection: samples,
  description: "keta_samples_v3_2_12_all_splits",
  fileFormat: "CSV"
});

Export.image.toDrive({
  image: vizProb_jun2023.toFloat(),
  description: "keta_flood_probability_jun2023_v3_2_12",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_feb2024.toFloat(),
  description: "keta_flood_probability_feb2024_v3_2_12",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_may2024.toFloat(),
  description: "keta_flood_probability_may2024_v3_2_12",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_jan2025.toFloat(),
  description: "keta_flood_probability_jan2025_v3_2_12",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_feb2025.toFloat(),
  description: "keta_flood_probability_feb2025_v3_2_12",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_mar2025.toFloat(),
  description: "keta_flood_probability_mar2025_v3_2_12",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});
...
Export.table.toDrive({
  ...
  description: "keta_samples_driver_v3_2_12_all_splits",
  fileFormat: "CSV"
});

Export.image.toDrive({
  image: driverProbMap_jun2023.toInt(),
  description: "keta_driver_classification_jun2023_v3_2_12",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});
