// =====================================================================
// KETA COASTAL FLOOD PREDICTION -- PRODUCTION GEE SCRIPT v3.2.8
...
// =====================================================================
// 13b. DRIVER ATTRIBUTION LABEL (Model B -- 2026-07-13)
//   0 = no flood        (flood == 0)
...
function getDriverLabel(floodBand, imergBands, freeboardBand) {
  ...
  var driver = ee.Image(0)
    ...
    .where(isFlood.and(heavyRain.not()).and(tidalInundation.not()), 2)
    .rename("flood_driver")
    .toInt();
...
Export.table.toDrive({
  collection: samples,
  description: "keta_samples_v3_2_8_all_splits",
  fileFormat: "CSV"
});

Export.image.toDrive({
  image: vizProb_jun2023.toFloat(),
  description: "keta_flood_probability_jun2023_v3_2_8",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_feb2024.toFloat(),
  description: "keta_flood_probability_feb2024_v3_2_8",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_may2024.toFloat(),
  description: "keta_flood_probability_may2024_v3_2_8",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_jan2025.toFloat(),
  description: "keta_flood_probability_jan2025_v3_2_8",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_feb2025.toFloat(),
  description: "keta_flood_probability_feb2025_v3_2_8",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});

Export.image.toDrive({
  image: vizProb_mar2025.toFloat(),
  description: "keta_flood_probability_mar2025_v3_2_8",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});
...
// =====================================================================
// 27. MODEL B TEST SET EVALUATION (4x4 confusion matrix)
// =====================================================================
...
print("Confusion Matrix (rows=actual, cols=predicted, order 0/1/2/3):", testDriverMatrix);
...
print("Confusion Matrix (rows=actual, cols=predicted, order 0/1/2/3):", valDriverMatrix);
...
var driverVis = {
  min: 0, max: 3,
  palette: ["FFFFFF", "1E90FF", "FFA500", "8B008B"]
};
...
Export.table.toDrive({
  ...
  description: "keta_samples_driver_v3_2_8_all_splits",
  fileFormat: "CSV"
});

Export.image.toDrive({
  image: driverProbMap_jun2023.toInt(),
  description: "keta_driver_classification_jun2023_v3_2_8",
  region: keta, scale: 30, fileFormat: "GeoTIFF"
});
